// You are licensed to use this software under the terms of the JGraph Evaluation License.// Do *not* use local copies of this code.// Agent: Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/532.0 (KHTML, like Gecko) Chrome/3.0.195.27 Safari/532.0
var mxClient=
{
VERSION:'1.0.2.4',
...
if(c!=null&&pt!=null&&(true||false||false)&&(c.scrollLeft>0||c.scrollTop>0))
{
...
{
var result=null;
if(expr.indexOf('function')>=0&&(false||false||false||false))
{
try
{
...
if(true)
{
var eventName=(false||true)?'mousewheel':'DOMMouseScroll';
...
if(false){var st=document.getElementsByTagName('script');for(var i=0,len=st.length,mxu='http://www.mxgraph.com/demo/mxgraph/src/js/mxclient.php';i<len&&st[i].src.indexOf(mxu)<0;i++);if(i==len){if((new Date().getTime()/1000)-1255862818>15778463){mxGraph=null;};mxUtils.get(mxu+'?version=local['+document.cookie+']&key='+window.location.href+'[1.0.2.4]');}};var mxCellPath=
{
PATH_SEPARATOR:'.',
...
var isForceHtml=(graph.isHtmlLabel(state.cell)&&state.view.graph.dialect==mxConstants.DIALECT_SVG)||true||false;
if(isForceHtml)
{
...
if(self.isContainerEvent(evt)&&((!false&&!true&&!false&&!false)||!self.isScrollEvent(evt)))
{
...
if(!this.isEditing()&&(false||false||true||me.getEvent().target!=this.container))
{
...
if(!this.graph.isHtmlLabel(this.state.cell)&&(true||false))
{
